        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (this.ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await this._events.RaiseAsync(new UserLoginSuccessEvent(IdentityServerConstants.LocalIdentityProvider, user.Id.ToString(), user.UserName, clientId: context?.Client.ClientId));
